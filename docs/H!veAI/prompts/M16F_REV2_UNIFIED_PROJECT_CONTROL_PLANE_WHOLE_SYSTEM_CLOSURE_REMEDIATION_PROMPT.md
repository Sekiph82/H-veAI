...
> `M16F_REV3_UNIFIED_PROJECT_CONTROL_PLANE_WHOLE_SYSTEM_CLOSURE_REMEDIATION_PROMPT.md`
>
> Reason: owner supplied native screenshots for the full eight-project portfolio and Command Center, exposing additional portfolio-wide reconciliation, fault-isolation, task-resolution and nested-source defects that must be fixed in the same run.

# M16F REV2 + Unified Project Control Plane Whole-System Closure Remediation Prompt
