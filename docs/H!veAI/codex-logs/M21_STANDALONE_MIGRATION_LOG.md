...
| `Sekiph82/PackLab-3D` | `main` | `M00` / no exact task declared | Define the first approved PackLab 3D task | 0/0 | `fc6d732ee6f6d557b3b9f975520cfc275d2f88fd` — canonicalize TASKS filename casing | `fc6d732ee6f6d557b3b9f975520cfc275d2f88fd` |
| `Sekiph82/Scrubbots` | `main` | `M19` / `M19-C001-V05` Callback-order and direct-observability gaps | Independently audit M19-C001 V05 | 236/778 | `64d24f8843b64aab766806450f7910fbbc3e48e2` — canonicalize TASKS filename casing | `64d24f8843b64aab766806450f7910fbbc3e48e2` |
| `Sekiph82/ScrubBots-Level-Factory` | `main` | `PAG-M08` / `PAG-M08-C001` Output / Export Contract | Execute the authoritative task prompt and publish evidence | 259/392 | `760042785d81abf95c3d19ff422e514a3af46c65` — canonicalize TASKS filename casing | `760042785d81abf95c3d19ff422e514a3af46c65` |
