...
Preserve the old product with an archival tag/branch. H!veAI is a product
rebuild, not a cosmetic rename. Upgrade Tauri 1.x to Tauri 2 before core
orchestration work. Retain reusable infrastructure only after audit.
Do not destroy old local data without explicit backup/migration policy.
