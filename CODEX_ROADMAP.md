...
- M16T V10 Codex-only audit provider schema-status and representative-readiness parity remediation is implementation-complete and awaiting independent strict audit and owner native re-acceptance. Required Actor is HUMAN; M17 remains NOT ACTIVATED/BLOCKED.
- Strict completed progress is 16/20 = 80%; M16 remains OPEN during M16T V10, and the pre-M10 hotfix is not a numbered roadmap milestone.
...
The package notes below are historical implementation snapshots. Current prospective truth is recorded above: M21 and M21-R01 through M21-R03 are accepted, M16T V10 is implementation-complete and awaiting independent audit plus owner native re-acceptance, and M17 is not activated.
