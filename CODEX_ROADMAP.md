...
- M16T V11 Codex-only audit provider structured-output subset and readiness diagnostic parity remediation is validated complete. M17 V05 is limited to F-M17-V04-001 through F-M17-V04-003 and remains open pending independent re-audit plus owner-native Claude workflow acceptance; M18-M20 remain blocked by dependency order.
