...
- M16T V01 Codex-only audit provider migration is active. Required Actor is CODEX; M17 remains NOT ACTIVATED/BLOCKED.
- Strict completed progress is 16/20 = 80%; M16 remains OPEN during M16T, and the pre-M10 hotfix is not a numbered roadmap milestone.
...
The package notes below are historical implementation snapshots. Current prospective truth is recorded above: M21 and M21-R01 through M21-R03 are accepted, M16T V01 is implementation-complete and awaiting independent audit plus owner native acceptance, and M17 is not activated.
...
M16T V01 IMPLEMENTATION COMPLETE / PENDING INDEPENDENT STRICT AUDIT + OWNER NATIVE ACCEPTANCE. M16 REMAINS OPEN. M17 NOT ACTIVATED/BLOCKED.
